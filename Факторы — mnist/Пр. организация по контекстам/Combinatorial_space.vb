...
Public Class Combinatorial_space
    ...
    Dim con_optim_count As Integer = 0
    Const con_optim_period As Integer = 100
    Const min_P As Double = 0.8
    ...
    Dim out_code_set_of_hashs() As Dictionary(Of String, mem_recept_cluster)
    ...
    'Public Sub con_optim()

    '    If con_optim_count > con_optim_period Then
    '        con_optim_count = 0
    ...
    'Friend Sub learn(ByRef source_bin As BitArray, ByRef target_bin As BitArray)

    '    For Each p In points
    '        For Each m In p.memory

    '            'm.Learn_3(source_bin, target_bin(p.out_bit))
    '            'm.Learn_4(source_bin, target_bin(p.out_bit))
            ...
            If p.memory.Count > 0 Then
                ...
                For i = p.memory.Count - 1 To 0 Step -1
                    ...
                    With p.memory(i)
                        ...
                        'If .status = status_type.tmp AndAlso .N_activate >= N_conf Then
...
'Class common_memory_item
'    Public bin As BitArray
'    Public out_code As BitArray
'    Public txt As String

'    Public Sub New(ByRef new_bin As BitArray, ByRef new_hash As BitArray, ByRef new_txt As String)
'        bin = new_bin.Clone
'        out_code = new_hash.Clone
'        txt = new_txt
'    End Sub
'End Class
